...
import 'package:whitelableapp/components/home_screen/address_field.dart';
                    ...
                    child: Widgets().textButton(
                      onPressed: () async {
                        if(selectedType.isEmpty){
                          LoginScreenWidgets().showAlertDialog(alertMessage: getTranslated(context, ["addNewAddressScreen", "alert", "type"]), context: context,);
                        }else if(streetController.text.isEmpty){
                          LoginScreenWidgets().showAlertDialog(alertMessage: getTranslated(context, ["message", "streetRequire"]), context: context,);
                        }else if(areaController.text.isEmpty){
                          LoginScreenWidgets().showAlertDialog(alertMessage: getTranslated(context, ["message", "areaRequire"]), context: context,);
                        }else if(cityController.text.isEmpty){
                          LoginScreenWidgets().showAlertDialog(alertMessage: getTranslated(context, ["message", "cityRequire"]), context: context,);
                        }else if(stateController.text.isEmpty){
                          LoginScreenWidgets().showAlertDialog(alertMessage: getTranslated(context, ["message", "stateRequire"]), context: context,);
                        }else if(countryController.text.isEmpty){
                          LoginScreenWidgets().showAlertDialog(alertMessage: getTranslated(context, ["message", "countryRequire"]), context: context,);
                        }else if(postCodeController.text.isEmpty){
                          LoginScreenWidgets().showAlertDialog(alertMessage: getTranslated(context, ["message", "postCodeRequire"]), context: context,);
                        }else{
                          if(widget.isEdit){
                            ...
                            if(response.statusCode == 201){
                              ...
                              if(data.containsKey("detail")){
                                print("---- ${data["detail"]}");
                                LoginScreenWidgets().showAlertDialog(alertMessage: data["detail"], context: context,
                                );
                              }else{
                                print("something went wrong");
                                LoginScreenWidgets().showAlertDialog(alertMessage: "Something went wrong", context: context,);
                              }
                            }
